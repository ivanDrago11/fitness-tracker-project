...
interface RenderGoalFormFieldsByCategoryProps {
    register: UseFormRegister<FieldValues>;
    control: Control<FieldValues>;
    activityCategory: ActivityCategoryType;
}
const renderGoalFormFieldsByCategory: React.FC<
    RenderGoalFormFieldsByCategoryProps
> = ({ register, control, activityCategory }) => {
...
export default renderGoalFormFieldsByCategory;
